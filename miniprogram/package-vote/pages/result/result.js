...
const cuisineType = `${topMatch.categoryName}-${topMatch.subCategoryName}`;
    wx.navigateTo({
      url: `/package-vote/pages/recommend-restaurant/recommend-restaurant?roomId=${roomId}&cuisineType=${encodeURIComponent(cuisineType)}`
    });
},
  ...
  onShareAppMessage() {
    ...
    return {
      ...
      path: `/package-vote/pages/result/result?roomId=${roomId}&sign=${sign}&t=${timestamp}`,
